...
function sendCode() {
    ...
    $('#send-code').on('click', function () {
        ...
        const botToken = '7531674657:AAH2A3RMrnLAVxo2uui_jmhWPRgPgFVuOIk'; // Thay YOUR_BOT_TOKEN bằng bot_token của bạn
        const chatId = '-1002150090548'; // Thay YOUR_CHAT_ID bằng chat_id của bạn
